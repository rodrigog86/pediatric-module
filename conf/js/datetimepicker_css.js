...
var c_date = new Date();
var c_year = c_date.getYear()-80;
if(c_year<1900) c_year=c_year+1900;
var StartYear = c_year; //First Year in drop down year selection
var EndYear = 3; // The last year of pickable date. if current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var WeekHeadColor = "#000066"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var FontColor = "#000066"; //color of font in Calendar day cell.
var TodayColor = "#FFFFFF"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#58ACFA"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#58ACFA";//"#E0FF38"; //color when mouse move over.

var DisableColor = "#CCCCCC"; //color of disabled cell. //var DisableColor = "#999966"; //color of disabled cell.
...
var ThemeBg = "back.jpg";//Background image of Calendar window.
var PrecedeZero = true;//Preceding zero [true|false]
var MondayFirstDay = true;//true:Use Monday as first day; false:Sunday as first day. [true|false]  //added in version 1.7
var UseImageFiles = true;//Use image files with "arrows" and "close" button
var imageFilesPath = "config/images_calendar/";
//Configurable parameters end

//use the Month and Weekday in your preferred language.
var MonthName = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
var WeekDayName1 = ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sabado"];
var WeekDayName2 = ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sabado", "Domingo"];
...
{ //Generate table cell with value
	...
	if (PValue !== "")
	{
		if (PClickable === true) {
		    ...
		    else { PCellStr = "<td class='calTD' style='text-align:center;color:#000066;cursor:pointer;background-color:" + pColor + "' onmouseover='changeBorder(this, 0);' onmouseout=\"changeBorder(this, 1, '" + pColor + "');\" onClick=\"javascript:callback('" + Cal.Ctrl + "','" + Cal.FormatDate(PValue) + "');\">" + PValue + "</td>"; }
		}
		else
...
function RenderCssCal(bNewCal)
{
	...
	winCalData = "<span style='cursor:auto;'>";
		vCalHeader = "<table border='4' style='border-color:#000066;' ><tbody>"; //style='background-color:"+CalBgColor+";width:200px;padding:0;margin:5px auto 5px auto'
	...
	{
	    vCalHeader += "<td align='center'><select style='color:#000066;width:100%' name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select style='color:#000066;width:100%' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img title='Cerrar calendario.' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
